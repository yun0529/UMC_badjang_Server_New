...
public class ScholarshipDao {
    ...
    // Scholarship 테이블에 존재하는 전체 장학금의 정보 조회
    public List<GetScholarshipRes> getScholarships() {
        String getScholarshipsQuery = "select * from Scholarship where scholarship_status = 'Y'"; //Scholarship 테이블에 존재하는 모든 회원들의 정보를 조회하는 쿼리
