...
public class SupportController {
    ...
    public BaseResponse<List<GetSupportRes>> getSupports(@RequestParam(required = false)Integer category, @RequestParam(required = false)Integer filter, @RequestParam(required = false)Integer order){
